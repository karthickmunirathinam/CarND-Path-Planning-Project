    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "")
      {
        ...
        if (event == "telemetry")
        {
          ...
          {
            // Simple lane change decision instance. Left lane change is given priority.
            // Can be more complex in real world scenario.
          ...
          //In Frenet add evenly 30m spaced pointa ahead of starting frames
          ...
          {
            //shift our car reference to 0 degree
